...
Next.js 15 includes React 19 support, which is now stable as of Next.js 15.1. Here's a React 19 compatible setup:
...
The recommended GSAP integration has been updated for the latest versions:
...
This implementation provides smooth, performant scrolling throughout your Next.js 15 application while maintaining compatibility with React 19 and following current best practices.
