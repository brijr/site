...
const styles = {
  typography: {
    base: [
      ...
      "[&_h5]:text-xl [&_h5]:font-medium [&_h5]:tracking-tight [&_h5]:mt-4 [&_h5]:mb-2",
      "[&_h6]:text-xl [&_h6]:font-medium [&_h6]:tracking-tight [&_h6]:mt-4 [&_h6]:mb-2",
      // Text elements
      "[&_p]:text-xl [&_p]:leading-tight [&_p]:tracking-tight [&_p]:mb-4",
